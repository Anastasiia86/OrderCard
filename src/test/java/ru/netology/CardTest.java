...
public class CardTest {
    ...
    public void shouldSuccessfulCard() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79696789449");
    ...
    @Test
    public void shouldNameFieldValidationWithDash() {
        driver.get("http://localhost:9999");
    ...
    public void shouldPhoneFieldValidation() {
        driver.get("http://localhost:9999");
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Мария Петрова");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+7969-678-94-49");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
